...
const CRATE_DEFS = [
  { id: 'common',    name: 'Common Crate',    icon: '📦', price: 5,  odds: [['pro',0.85],['impact',0.15]] },
  { id: 'uncommon',  name: 'Uncommon Crate',  icon: '🗃️', price: 10, odds: [['impact',0.80],['clutch',0.20]] },
  { id: 'rare',      name: 'Rare Crate',      icon: '💠', price: 25, odds: [['clutch',0.75],['elite',0.25]] },
  { id: 'epic',      name: 'Epic Crate',      icon: '💜', price: 50, odds: [['elite',0.70],['superstar',0.30]] },
  { id: 'legendary', name: 'Legendary Crate', icon: '🏆', price: 90, odds: [['superstar',0.80],['gamebreaker',0.20]] }
];
...
// Team emoji map (Unicode flags / logos approximate)
const TEAM_EMOJI = {
  BOS:'🍀', NYK:'🗽', PHI:'🔔', BKN:'🖤', TOR:'🦕',
...
const CARD_POOL = [
  ...
  /* ──────────────── BOSTON CELTICS ──────────────── */
  { id:'bos_tatum', name:'Jayson Tatum', team:'BOS', pos:'SF', rarity:'gamebreaker', no:0,
  ...
  { id:'bos_brown', name:'Jaylen Brown', team:'BOS', pos:'SG', rarity:'superstar', no:7,
  ...
  { id:'bos_porzingis', name:'Kristaps Porzingis', team:'BOS', pos:'C', rarity:'elite', no:8,
  ...
  { id:'bos_holiday', name:'Jrue Holiday', team:'BOS', pos:'PG', rarity:'clutch', no:11,
  ...
  { id:'bos_pritchard', name:'Payton Pritchard', team:'BOS', pos:'PG', rarity:'impact', no:11,
  ...
  { id:'bos_horford', name:'Al Horford', team:'BOS', pos:'C', rarity:'pro', no:42,
  ...
  /* ──────────────── NEW YORK KNICKS ──────────────── */
  { id:'nyk_towns', name:'Karl-Anthony Towns', team:'NYK', pos:'C', rarity:'superstar', no:32,
  ...
  { id:'nyk_brunson', name:'Jalen Brunson', team:'NYK', pos:'PG', rarity:'superstar', no:11,
  ...
  { id:'nyk_bridges', name:'Mikal Bridges', team:'NYK', pos:'SF', rarity:'elite', no:25,
  ...
  { id:'nyk_anunoby', name:'OG Anunoby', team:'NYK', pos:'SF', rarity:'clutch', no:8,
  ...
  { id:'nyk_hart', name:'Josh Hart', team:'NYK', pos:'SG', rarity:'impact', no:3,
  ...
  { id:'nyk_robinson', name:'Mitchell Robinson', team:'NYK', pos:'C', rarity:'pro', no:23,
  ...
  /* ──────────────── PHILADELPHIA 76ERS ──────────────── */
  { id:'phi_embiid', name:'Joel Embiid', team:'PHI', pos:'C', rarity:'superstar', no:21,
  ...
  { id:'phi_maxey', name:'Tyrese Maxey', team:'PHI', pos:'PG', rarity:'superstar', no:0,
  ...
  { id:'phi_george', name:'Paul George', team:'PHI', pos:'SF', rarity:'elite', no:8,
  ...
  { id:'phi_oubre', name:'Kelly Oubre Jr.', team:'PHI', pos:'SF', rarity:'clutch', no:12,
  ...
  { id:'phi_harris', name:'Tobias Harris', team:'PHI', pos:'PF', rarity:'impact', no:12,
  ...
  { id:'phi_drummond', name:'Andre Drummond', team:'PHI', pos:'C', rarity:'pro', no:1,
  ...
  /* ──────────────── BROOKLYN NETS ──────────────── */
  { id:'bkn_thomas', name:'Cam Thomas', team:'BKN', pos:'SG', rarity:'clutch', no:5,
  ...
  { id:'bkn_claxton', name:'Nic Claxton', team:'BKN', pos:'C', rarity:'clutch', no:33,
  ...
  { id:'bkn_schroder', name:'Dennis Schröder', team:'BKN', pos:'PG', rarity:'impact', no:17,
  ...
  { id:'bkn_finneysmith', name:'Dorian Finney-Smith', team:'BKN', pos:'SF', rarity:'impact', no:28,
  ...
  { id:'bkn_sharpe', name:'Day\'Ron Sharpe', team:'BKN', pos:'C', rarity:'pro', no:20,
  ...
  { id:'bkn_clowney', name:'Noah Clowney', team:'BKN', pos:'PF', rarity:'pro', no:21,
  ...
  /* ──────────────── TORONTO RAPTORS ──────────────── */
  { id:'tor_barnes', name:'Scottie Barnes', team:'TOR', pos:'SF', rarity:'elite', no:4,
  ...
  { id:'tor_quickley', name:'Immanuel Quickley', team:'TOR', pos:'PG', rarity:'clutch', no:5,
  ...
  { id:'tor_barrett', name:'RJ Barrett', team:'TOR', pos:'SG', rarity:'clutch', no:9,
  ...
  { id:'tor_poeltl', name:'Jakob Poeltl', team:'TOR', pos:'C', rarity:'clutch', no:25,
  ...
  { id:'tor_dick', name:'Gradey Dick', team:'TOR', pos:'SG', rarity:'impact', no:1,
  ...
  { id:'tor_brown', name:'Bruce Brown', team:'TOR', pos:'SF', rarity:'pro', no:11,
  ...
  /* ──────────────── CHICAGO BULLS ──────────────── */
  { id:'chi_lavine', name:'Zach LaVine', team:'CHI', pos:'SG', rarity:'elite', no:8,
  ...
  { id:'chi_vucevic', name:'Nikola Vucevic', team:'CHI', pos:'C', rarity:'clutch', no:9,
  ...
  { id:'chi_white', name:'Coby White', team:'CHI', pos:'PG', rarity:'clutch', no:0,
  ...
  { id:'chi_giddey', name:'Josh Giddey', team:'CHI', pos:'PG', rarity:'impact', no:10,
  ...
  { id:'chi_williams', name:'Patrick Williams', team:'CHI', pos:'PF', rarity:'impact', no:44,
  ...
  { id:'chi_dosunmu', name:'Ayo Dosunmu', team:'CHI', pos:'PG', rarity:'pro', no:12,
  ...
  /* ──────────────── CLEVELAND CAVALIERS ──────────────── */
  { id:'cle_mitchell', name:'Donovan Mitchell', team:'CLE', pos:'PG', rarity:'superstar', no:45,
  ...
  { id:'cle_garland', name:'Darius Garland', team:'CLE', pos:'PG', rarity:'elite', no:10,
  ...
  { id:'cle_mobley', name:'Evan Mobley', team:'CLE', pos:'PF', rarity:'elite', no:4,
  ...
  { id:'cle_allen', name:'Jarrett Allen', team:'CLE', pos:'C', rarity:'clutch', no:31,
  ...
  { id:'cle_strus', name:'Max Strus', team:'CLE', pos:'SG', rarity:'impact', no:1,
  ...
  { id:'cle_levert', name:'Caris LeVert', team:'CLE', pos:'SG', rarity:'pro', no:3,
  ...
  /* ──────────────── DETROIT PISTONS ──────────────── */
  { id:'det_cunningham', name:'Cade Cunningham', team:'DET', pos:'PG', rarity:'elite', no:2,
  ...
  { id:'det_duren', name:'Jalen Duren', team:'DET', pos:'C', rarity:'clutch', no:0,
  ...
  { id:'det_thompson', name:'Ausar Thompson', team:'DET', pos:'SF', rarity:'clutch', no:5,
  ...
  { id:'det_stewart', name:'Isaiah Stewart', team:'DET', pos:'PF', rarity:'impact', no:28,
  ...
  { id:'det_bogdanovic', name:'Bojan Bogdanović', team:'DET', pos:'SF', rarity:'impact', no:44,
  ...
  { id:'det_hayes', name:'Killian Hayes', team:'DET', pos:'PG', rarity:'pro', no:7,
  ...
  /* ──────────────── INDIANA PACERS ──────────────── */
  { id:'ind_haliburton', name:'Tyrese Haliburton', team:'IND', pos:'PG', rarity:'elite', no:0,
  ...
  { id:'ind_siakam', name:'Pascal Siakam', team:'IND', pos:'PF', rarity:'clutch', no:43,
  ...
  { id:'ind_turner', name:'Myles Turner', team:'IND', pos:'C', rarity:'clutch', no:33,
  ...
  { id:'ind_mathurin', name:'Bennedict Mathurin', team:'IND', pos:'SG', rarity:'impact', no:00,
  ...
  { id:'ind_nesmith', name:'Aaron Nesmith', team:'IND', pos:'SF', rarity:'impact', no:23,
  ...
  { id:'ind_mcconnell', name:'T.J. McConnell', team:'IND', pos:'PG', rarity:'pro', no:9,
  ...
  /* ──────────────── MILWAUKEE BUCKS ──────────────── */
  { id:'mil_giannis', name:'Giannis Antetokounmpo', team:'MIL', pos:'PF', rarity:'gamebreaker', no:34,
  ...
  { id:'mil_lillard', name:'Damian Lillard', team:'MIL', pos:'PG', rarity:'superstar', no:0,
  ...
  { id:'mil_lopez', name:'Brook Lopez', team:'MIL', pos:'C', rarity:'clutch', no:11,
  ...
  { id:'mil_middleton', name:'Khris Middleton', team:'MIL', pos:'SF', rarity:'clutch', no:22,
  ...
  { id:'mil_portis', name:'Bobby Portis', team:'MIL', pos:'PF', rarity:'impact', no:9,
  ...
  { id:'mil_beasley', name:'Malik Beasley', team:'MIL', pos:'SG', rarity:'pro', no:5,
  ...
  /* ──────────────── ATLANTA HAWKS ──────────────── */
  { id:'atl_young', name:'Trae Young', team:'ATL', pos:'PG', rarity:'superstar', no:11,
  ...
  { id:'atl_murray', name:'Dejounte Murray', team:'ATL', pos:'PG', rarity:'elite', no:10,
  ...
  { id:'atl_capela', name:'Clint Capela', team:'ATL', pos:'C', rarity:'clutch', no:15,
  ...
  { id:'atl_hunter', name:'De\'Andre Hunter', team:'ATL', pos:'SF', rarity:'clutch', no:12,
  ...
  { id:'atl_bogdanovic', name:'Bogdan Bogdanović', team:'ATL', pos:'SG', rarity:'impact', no:13,
  ...
  { id:'atl_okongwu', name:'Onyeka Okongwu', team:'ATL', pos:'C', rarity:'pro', no:17,
  ...
  /* ──────────────── CHARLOTTE HORNETS ──────────────── */
  { id:'cha_lamelo', name:'LaMelo Ball', team:'CHA', pos:'PG', rarity:'elite', no:1,
  ...
  { id:'cha_miller', name:'Brandon Miller', team:'CHA', pos:'SF', rarity:'clutch', no:24,
  ...
  { id:'cha_bridges_m', name:'Miles Bridges', team:'CHA', pos:'PF', rarity:'clutch', no:0,
  ...
  { id:'cha_gwilliams', name:'Grant Williams', team:'CHA', pos:'PF', rarity:'impact', no:2,
  ...
  { id:'cha_mann', name:'Tre Mann', team:'CHA', pos:'PG', rarity:'pro', no:23,
  ...
  { id:'cha_richards', name:'Nick Richards', team:'CHA', pos:'C', rarity:'pro', no:4,
  ...
  /* ──────────────── MIAMI HEAT ──────────────── */
  { id:'mia_adebayo', name:'Bam Adebayo', team:'MIA', pos:'C', rarity:'elite', no:13,
  ...
  { id:'mia_herro', name:'Tyler Herro', team:'MIA', pos:'SG', rarity:'elite', no:14,
  ...
  { id:'mia_rozier', name:'Terry Rozier', team:'MIA', pos:'PG', rarity:'clutch', no:2,
  ...
  { id:'mia_jovic', name:'Nikola Jović', team:'MIA', pos:'PF', rarity:'clutch', no:5,
  ...
  { id:'mia_highsmith', name:'Haywood Highsmith', team:'MIA', pos:'SF', rarity:'impact', no:24,
  ...
  { id:'mia_robinson', name:'Duncan Robinson', team:'MIA', pos:'SG', rarity:'pro', no:55,
  ...
  /* ──────────────── ORLANDO MAGIC ──────────────── */
  { id:'orl_banchero', name:'Paolo Banchero', team:'ORL', pos:'PF', rarity:'elite', no:5,
  ...
  { id:'orl_fwagner', name:'Franz Wagner', team:'ORL', pos:'SF', rarity:'clutch', no:21,
  ...
  { id:'orl_carter', name:'Wendell Carter Jr.', team:'ORL', pos:'C', rarity:'clutch', no:34,
  ...
  { id:'orl_suggs', name:'Jalen Suggs', team:'ORL', pos:'PG', rarity:'clutch', no:4,
  ...
  { id:'orl_mwagner', name:'Moritz Wagner', team:'ORL', pos:'C', rarity:'impact', no:21,
  ...
  { id:'orl_harris', name:'Gary Harris', team:'ORL', pos:'SG', rarity:'pro', no:14,
  ...
  /* ──────────────── WASHINGTON WIZARDS ──────────────── */
  { id:'was_kuzma', name:'Kyle Kuzma', team:'WAS', pos:'PF', rarity:'clutch', no:33,
  ...
  { id:'was_poole', name:'Jordan Poole', team:'WAS', pos:'PG', rarity:'clutch', no:13,
  ...
  { id:'was_gafford', name:'Daniel Gafford', team:'WAS', pos:'C', rarity:'clutch', no:21,
  ...
  { id:'was_avdija', name:'Deni Avdija', team:'WAS', pos:'SF', rarity:'impact', no:8,
  ...
  { id:'was_coulibaly', name:'Bilal Coulibaly', team:'WAS', pos:'SF', rarity:'impact', no:0,
  ...
  { id:'was_jones', name:'Tyus Jones', team:'WAS', pos:'PG', rarity:'pro', no:5,
  ...
  /* ──────────────── DENVER NUGGETS ──────────────── */
  { id:'den_jokic', name:'Nikola Jokić', team:'DEN', pos:'C', rarity:'gamebreaker', no:15,
  ...
  { id:'den_murray', name:'Jamal Murray', team:'DEN', pos:'PG', rarity:'elite', no:27,
  ...
  { id:'den_porter', name:'Michael Porter Jr.', team:'DEN', pos:'SF', rarity:'elite', no:1,
  ...
  { id:'den_gordon', name:'Aaron Gordon', team:'DEN', pos:'PF', rarity:'clutch', no:50,
  ...
  { id:'den_kcp', name:'Kentavious Caldwell-Pope', team:'DEN', pos:'SG', rarity:'impact', no:5,
  ...
  { id:'den_jackson', name:'Reggie Jackson', team:'DEN', pos:'PG', rarity:'pro', no:7,
  ...
  { id:'min_edwards', name:'Anthony Edwards', team:'MIN', pos:'SG', rarity:'superstar', no:5,
  ...
  { id:'min_randle', name:'Julius Randle', team:'MIN', pos:'PF', rarity:'elite', no:30,
  ...
  { id:'min_gobert', name:'Rudy Gobert', team:'MIN', pos:'C', rarity:'clutch', no:27,
  ...
  { id:'min_mcdaniels', name:'Jaden McDaniels', team:'MIN', pos:'SF', rarity:'clutch', no:3,
  ...
  { id:'min_reid', name:'Naz Reid', team:'MIN', pos:'C', rarity:'impact', no:11,
  ...
  { id:'min_conley', name:'Mike Conley', team:'MIN', pos:'PG', rarity:'pro', no:10,
  ...
  { id:'okc_sga', name:'Shai Gilgeous-Alexander', team:'OKC', pos:'PG', rarity:'gamebreaker', no:2,
  ...
  { id:'okc_jwilliams', name:'Jalen Williams', team:'OKC', pos:'SG', rarity:'elite', no:8,
  ...
  { id:'okc_holmgren', name:'Chet Holmgren', team:'OKC', pos:'C', rarity:'elite', no:7,
  ...
  { id:'okc_hartenstein', name:'Isaiah Hartenstein', team:'OKC', pos:'C', rarity:'clutch', no:55,
  ...
  { id:'okc_dort', name:'Luguentz Dort', team:'OKC', pos:'SG', rarity:'clutch', no:5,
  ...
  { id:'okc_awiggins', name:'Aaron Wiggins', team:'OKC', pos:'SG', rarity:'pro', no:21,
  ...
  { id:'por_simons', name:'Anfernee Simons', team:'POR', pos:'PG', rarity:'clutch', no:1,
  ...
  { id:'por_grant', name:'Jerami Grant', team:'POR', pos:'PF', rarity:'clutch', no:9,
  ...
  { id:'por_sharpe', name:'Shaedon Sharpe', team:'POR', pos:'SG', rarity:'clutch', no:17,
  ...
  { id:'por_henderson', name:'Scoot Henderson', team:'POR', pos:'PG', rarity:'impact', no:00,
  ...
  { id:'por_camara', name:'Toumani Camara', team:'POR', pos:'SF', rarity:'impact', no:33,
  ...
  { id:'por_walker', name:'Jabari Walker', team:'POR', pos:'PF', rarity:'pro', no:34,
  ...
  /* ──────────────── UTAH JAZZ ──────────────── */
  { id:'uta_markkanen', name:'Lauri Markkanen', team:'UTA', pos:'PF', rarity:'elite', no:23,
  ...
  { id:'uta_kessler', name:'Walker Kessler', team:'UTA', pos:'C', rarity:'clutch', no:24,
  ...
  { id:'uta_sexton', name:'Collin Sexton', team:'UTA', pos:'PG', rarity:'clutch', no:2,
  ...
  { id:'uta_clarkson', name:'Jordan Clarkson', team:'UTA', pos:'SG', rarity:'impact', no:00,
  ...
  { id:'uta_agbaji', name:'Ochai Agbaji', team:'UTA', pos:'SG', rarity:'impact', no:30,
  ...
  { id:'uta_george', name:'Keyonte George', team:'UTA', pos:'PG', rarity:'pro', no:3,
  ...
  { id:'gsw_curry', name:'Stephen Curry', team:'GSW', pos:'PG', rarity:'superstar', no:30,
  ...
  { id:'gsw_green', name:'Draymond Green', team:'GSW', pos:'PF', rarity:'clutch', no:23,
  ...
  { id:'gsw_wiggins', name:'Andrew Wiggins', team:'GSW', pos:'SF', rarity:'clutch', no:22,
  ...
  { id:'gsw_kuminga', name:'Jonathan Kuminga', team:'GSW', pos:'PF', rarity:'clutch', no:00,
  ...
  { id:'gsw_podziemski', name:'Brandin Podziemski', team:'GSW', pos:'SG', rarity:'impact', no:2,
  ...
  { id:'gsw_moody', name:'Moses Moody', team:'GSW', pos:'SG', rarity:'pro', no:4,
  ...
  /* ──────────────── LA CLIPPERS ──────────────── */
  { id:'lac_leonard', name:'Kawhi Leonard', team:'LAC', pos:'SF', rarity:'elite', no:2,
  ...
  { id:'lac_harden', name:'James Harden', team:'LAC', pos:'PG', rarity:'elite', no:1,
  ...
  { id:'lac_powell', name:'Norman Powell', team:'LAC', pos:'SG', rarity:'clutch', no:24,
  ...
  { id:'lac_zubac', name:'Ivica Zubac', team:'LAC', pos:'C', rarity:'clutch', no:40,
  ...
  { id:'lac_mann', name:'Terance Mann', team:'LAC', pos:'SF', rarity:'impact', no:14,
  ...
  { id:'lac_plumlee', name:'Mason Plumlee', team:'LAC', pos:'C', rarity:'pro', no:44,
  ...
  /* ──────────────── LOS ANGELES LAKERS ──────────────── */
  { id:'lal_lebron', name:'LeBron James', team:'LAL', pos:'SF', rarity:'gamebreaker', no:23,
  ...
  { id:'lal_davis', name:'Anthony Davis', team:'LAL', pos:'C', rarity:'superstar', no:3,
  ...
  { id:'lal_reaves', name:'Austin Reaves', team:'LAL', pos:'SG', rarity:'clutch', no:15,
  ...
  { id:'lal_russell', name:"D'Angelo Russell", team:'LAL', pos:'PG', rarity:'clutch', no:1,
  ...
  { id:'lal_hachimura', name:'Rui Hachimura', team:'LAL', pos:'PF', rarity:'impact', no:28,
  ...
  { id:'lal_prince', name:'Taurean Prince', team:'LAL', pos:'SF', rarity:'pro', no:12,
  ...
  /* ──────────────── PHOENIX SUNS ──────────────── */
  { id:'phx_durant', name:'Kevin Durant', team:'PHX', pos:'SF', rarity:'superstar', no:35,
  ...
  { id:'phx_booker', name:'Devin Booker', team:'PHX', pos:'SG', rarity:'elite', no:1,
  ...
  { id:'phx_beal', name:'Bradley Beal', team:'PHX', pos:'PG', rarity:'clutch', no:3,
  ...
  { id:'phx_nurkic', name:'Jusuf Nurkić', team:'PHX', pos:'C', rarity:'clutch', no:20,
  ...
  { id:'phx_allen', name:'Grayson Allen', team:'PHX', pos:'SG', rarity:'impact', no:7,
  ...
  { id:'phx_gordon', name:'Eric Gordon', team:'PHX', pos:'SG', rarity:'pro', no:23,
  ...
  /* ──────────────── SACRAMENTO KINGS ──────────────── */
  { id:'sac_fox', name:"De'Aaron Fox", team:'SAC', pos:'PG', rarity:'superstar', no:5,
  ...
  { id:'sac_sabonis', name:'Domantas Sabonis', team:'SAC', pos:'C', rarity:'elite', no:10,
  ...
  { id:'sac_kmurray', name:'Keegan Murray', team:'SAC', pos:'SF', rarity:'clutch', no:13,
  ...
  { id:'sac_monk', name:'Malik Monk', team:'SAC', pos:'SG', rarity:'clutch', no:0,
  ...
  { id:'sac_huerter', name:'Kevin Huerter', team:'SAC', pos:'SG', rarity:'impact', no:9,
  ...
  { id:'sac_barnes_h', name:'Harrison Barnes', team:'SAC', pos:'PF', rarity:'pro', no:40,
  ...
  /* ──────────────── MEMPHIS GRIZZLIES ──────────────── */
  { id:'mem_morant', name:'Ja Morant', team:'MEM', pos:'PG', rarity:'superstar', no:12,
  ...
  { id:'mem_jjjr', name:'Jaren Jackson Jr.', team:'MEM', pos:'C', rarity:'elite', no:13,
  ...
  { id:'mem_bane', name:'Desmond Bane', team:'MEM', pos:'SG', rarity:'elite', no:22,
  ...
  { id:'mem_smart', name:'Marcus Smart', team:'MEM', pos:'PG', rarity:'clutch', no:36,
  ...
  { id:'mem_clarke', name:'Brandon Clarke', team:'MEM', pos:'PF', rarity:'impact', no:15,
  ...
  { id:'mem_kennard', name:'Luke Kennard', team:'MEM', pos:'SG', rarity:'pro', no:3,
  ...
  { id:'nop_zion', name:'Zion Williamson', team:'NOP', pos:'PF', rarity:'superstar', no:1,
  ...
  { id:'nop_ingram', name:'Brandon Ingram', team:'NOP', pos:'SF', rarity:'elite', no:14,
  ...
  { id:'nop_mccollum', name:'C.J. McCollum', team:'NOP', pos:'PG', rarity:'clutch', no:3,
  ...
  { id:'nop_valanciunas', name:'Jonas Valančiūnas', team:'NOP', pos:'C', rarity:'clutch', no:17,
  ...
  { id:'nop_jones', name:'Herb Jones', team:'NOP', pos:'SF', rarity:'impact', no:5,
  ...
  { id:'nop_alvarado', name:'Jose Alvarado', team:'NOP', pos:'PG', rarity:'pro', no:15,
  ...
  /* ──────────────── SAN ANTONIO SPURS ──────────────── */
  { id:'sas_wemby', name:'Victor Wembanyama', team:'SAS', pos:'C', rarity:'superstar', no:1,
  ...
  { id:'sas_vassell', name:'Devin Vassell', team:'SAS', pos:'SG', rarity:'clutch', no:24,
  ...
  { id:'sas_johnson', name:'Keldon Johnson', team:'SAS', pos:'SF', rarity:'clutch', no:3,
  ...
  { id:'sas_sochan', name:'Jeremy Sochan', team:'SAS', pos:'PF', rarity:'impact', no:10,
  ...
  { id:'sas_jones', name:'Tre Jones', team:'SAS', pos:'PG', rarity:'impact', no:33,
  ...
  { id:'sas_branham', name:'Malaki Branham', team:'SAS', pos:'SG', rarity:'pro', no:5,
  ...
  /* ──────────────── HOUSTON ROCKETS ──────────────── */
  { id:'hou_sengun', name:'Alperen Şengün', team:'HOU', pos:'C', rarity:'elite', no:28,
  ...
  { id:'hou_green', name:'Jalen Green', team:'HOU', pos:'SG', rarity:'elite', no:4,
  ...
  { id:'hou_vanvleet', name:'Fred VanVleet', team:'HOU', pos:'PG', rarity:'clutch', no:5,
  ...
  { id:'hou_smith', name:'Jabari Smith Jr.', team:'HOU', pos:'PF', rarity:'clutch', no:1,
  ...
  { id:'hou_brooks', name:'Dillon Brooks', team:'HOU', pos:'SF', rarity:'impact', no:9,
  ...
  { id:'hou_eason', name:'Tari Eason', team:'HOU', pos:'PF', rarity:'pro', no:17,
  ...
  /* ──────────────── DALLAS MAVERICKS ──────────────── */
  { id:'dal_doncic', name:'Luka Dončić', team:'DAL', pos:'PG', rarity:'gamebreaker', no:77,
  ...
  { id:'dal_irving', name:'Kyrie Irving', team:'DAL', pos:'PG', rarity:'superstar', no:11,
  ...
  { id:'dal_thompson_k', name:'Klay Thompson', team:'DAL', pos:'SG', rarity:'clutch', no:31,
  ...
  { id:'dal_washington', name:'P.J. Washington', team:'DAL', pos:'PF', rarity:'clutch', no:25,
  ...
  { id:'dal_lively', name:'Dereck Lively II', team:'DAL', pos:'C', rarity:'clutch', no:2,
  ...
  { id:'dal_green_j', name:'Josh Green', team:'DAL', pos:'SF', rarity:'pro', no:8,
